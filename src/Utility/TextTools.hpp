...
public:
	static std::string getTranslation(std::string stringLabel);
	static sf::Text createTextLabel(std::string string, sf::Vector2f position = sf::Vector2f(), int characterSize = globals::defaultTextSize, std::string font = globals::defaultTextFont, bool centerOrigin = false, sf::Color textColor = sf::Color::White, uint32_t textStyle = sf::Text::Regular);
	...
	static sf::Text createTextLabel(std::string string, sf::Vector2f boundingBox, bool allowWrapping, sf::Vector2f position = sf::Vector2f(), int characterSize = globals::defaultTextSize, std::string font = globals::defaultTextFont, bool centerOrigin = false, sf::Color textColor = sf::Color::White, uint32_t textStyle = sf::Text::Regular);
